    ...
    <div className="lg:grid lg:grid-cols-2 mb-16">
      <div className="py-8x max-w-3xl lg:max-w-md">
        ...
        <p className="text-gray-300x mt-5 md:h-48 md:overflow-y-auto md:overflow-hidden">
          Built with Vite, ReactJS, Built with Vite, ReactJS, and Vanilla JS, this weather website
          automatically detects your location or nearby areas and gives you the latest weather
          updates. Plus, it features a sleek dark mode theme, so you can stay up to date on the
