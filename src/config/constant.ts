...
export const MY_TWITTER_URL = process.env.NEXT_MY_TWITTER_URL || 'https://twitter.com/devshittu';
export const MY_LINKEDIN_URL =
  process.env.NEXT_MY_LINKEDIN_URL || 'https://linkedin.com/in/muhammedshittu';
